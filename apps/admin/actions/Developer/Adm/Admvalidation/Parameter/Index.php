<?php
/**
 * AdmFormsAq_adm_validation_pフォーム一覧表示へフォワードするクラス
 *
 * @access    public
 * @package   aquarium
 * @author    {author}
 * @version   $Id:$
 */
class Developer_Adm_Admvalidation_Parameter_Index extends AppAction
{
    /**
    ...
    function execute(&$data, &$context)
    {
        ...
        $action =& new Developer_Adm_Admvalidation_Parameter_Lst();
