<?php
/**
 * AdmFormsAq_adm_validationフォーム一覧表示へフォワードするクラス
 *
 * @access    public
 * @package   aquarium
 * @author    {author}
 * @version   $Id:$
 */
class Developer_Adm_Adm_Relation_Element_Validation_Parameterro_Index extends AppAction
{
    /**
    ...
    function execute(&$data, &$context)
    {
        ...
        $action =& new Developer_Adm_Adm_Relation_Element_Validation_Parameterro_Lst();
