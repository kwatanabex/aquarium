 ...
 * @version   $Id:$
 */
class Developer_Adm_Adm_Relation_Element_Validation_Parameter_Index extends AppAction
{
    /**
    ...
    function execute(&$data, &$context)
    {
        ...
        $action =& new Developer_Adm_Adm_Relation_Element_Validation_Parameter_Lst();
