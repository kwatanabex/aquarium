...
/**
 * AdmFormsAq_adm_column_validationフォーム一覧表示クラス
 *
 * @access    public
 * @package   aquarium
 * @author    {author}
 * @version   $Id:$
 */
class Developer_Adm_Admtable_Column_Validationro_Lst extends SyL_AdmFlowLst
{
    /**
     * アクションフォームクラス名
     *
     ...
     * @var string
     */
    var $classname = 'Adm.Forms.Aq_adm_column_validationro';
