<?php
/**
 * AdmFormsAq_adm_column_validation_pフォーム一覧表示へフォワードするクラス
 *
 * @access    public
 * @package   aquarium
 * @author    {author}
 * @version   $Id:$
 */
class Developer_Adm_Admtable_Column_Validation_Parameterro_Index extends AppAction
{
    /**
    ...
    function execute(&$data, &$context)
    {
        ...
        $action =& new Developer_Adm_Admtable_Column_Validation_Parameterro_Lst();
