<?php
/**
 * AdmTablesAq_adm_column_validation_pテーブルクラス
 *
 * @access    public
 * @package   aquarium
 * @author    {author}
 * @version   $Id:$
 */
class AdmTablesAq_adm_column_validation_p extends SyL_DBDaoTable
{
/**
 * テーブル名
 * 
 ...
 * @var string
 */
var $table = 'aq_adm_column_validation_p';
/**
 * プライマリキーカラム
 * 
 * @access protected
...
var $foreigns = array (
  ...
  'aq_adm_column_validation' => 
  array (
    'COLUMN_VALIDATION_ID' => 'COLUMN_VALIDATION_ID',
  ),
);
/**
 * カラム定義
